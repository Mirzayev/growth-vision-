...
export default function ContactForm() {
  ...
  return (
    <section className=" flex items-center justify-center bg-[#0A192F] sm:p-6 p-3">
      <motion.div
      ...
      >
        {/* Chap taraf - rasm */}
        <div className="hidden md:flex items-center justify-center bg-[#112240] pl-4">
          <img
            ...
            <form onSubmit={onSubmit} className="md:space-y-8 space-y-5">
              ...
              <div>
                ...
                <PhoneInput
                  ...
                  specialLabel="" // 
                  inputClass="!w-full !rounded-xl !border !border-slate-700 !bg-[#1E293B] !px-10 !py-[12px] !text-slate-100 !placeholder-slate-400 focus:!border-blue-400"
                  buttonClass="!border-none !bg-transparent"
                  containerClass="w-full"
                />

                {/* <input className="!w-full !rounded-xl !border !border-slate-700 !bg-[#1E293B] !px-10 !py-[18px] !text-slate-100 !placeholder-slate-400 focus:!border-blue-400" type="text" /> */}
              </div>
